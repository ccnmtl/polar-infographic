Columns = function(){
    ...
    this.addColumn = function(tab_one, tab_two, tab_three, tab_four, new_title, pic, content){
    	...
    	var json_obj = { position: {tab_1: tab_one, tab_2: tab_two, tab_3: tab_three, tab_4: tab_four}, title: new_title, image: pic, text: content};
...
jQuery(document).ready(function() {
    ...
    console.log("initColumn.columnArray");
    console.log(initColumn.columnArray);
    console.log("initColumn.columnArray[0]");
    console.log(initColumn.columnArray[0]);
    console.log("initColumn.columnArray['0']");
    console.log(initColumn.columnArray['0']);
